...
app.values_frame = MyValuesScrollableFrame(frame2, device.data, width=950, height=230)
app.values_frame.draw_frame(row=0, column=1)

app.control_frame = MyControlFrame(frame1, device, app.connection_frame, app.values_frame)
